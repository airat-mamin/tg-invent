...
HELP = (
    ...
    "После распознавания можно отправить геопозицию: бот определит город и улицу, "
    "а номер кабинета нужно ввести отдельно."
)
...
ASK_LOCATION = (
    ...
    "Нажмите «Отправить геопозицию» — по координатам определю город, улицу и дом. "
    "Кабинет Telegram не знает, его нужно ввести отдельно.\n\n"
    "Можно сразу написать адрес текстом, например: <code>Москва, Ленина 5</code>."
)
ASK_ROOM = (
    "Какой номер кабинета? Например: <code>12</code>\n"
    "Отправьте <code>-</code>, если кабинета нет."
)
GEO_FAILED = (
    "Не удалось определить улицу по координатам. "
    "Напишите адрес текстом, например: <code>Москва, Ленина 5</code>."
)
ROOM_INVALID = "Номер кабинета: до 12 символов, цифры и буквы. Попробуйте ещё раз."
LOCATION_SAVED = "Расположение сохранено."
LOCATION_SKIPPED = "Расположение не указано — его можно добавить позже через «Исправить»."
